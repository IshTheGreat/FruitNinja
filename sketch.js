...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    else
    {
      ...
      //if the score reaches 4 ,then the fruitgroup velocityX is blah
      //same thing with the monsters, their velocity also increases within the time that the score turns into 10, and keeps on increasing. 
    }
  }
